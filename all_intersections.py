...
path_obj_file = directory + R"\Fv_single\Intersections\all_intersections_hex.obj"
path_txt_file = directory + R"\Fv_single\Intersections\all_intersections_hex.txt"
